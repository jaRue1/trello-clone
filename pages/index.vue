        ...
        <v-form ref="form" v-model="valid">
          <div class="d-flex flex-column">
            ...
            <v-text-field
              ...
              v-model="board.title"
            ></v-text-field>
            <!-- set enableColor to true if it was initially false -->
            ...
            ></v-color-picker>
            <!-- on click trigger the choose image function -->
            <div
            ...
            >
            <!-- if fileToUpload is false or fileToUpload is exactly equal to 0 -->
              <template
              ...
              <!-- exceute the following -->
               ...
               <!-- if fileToUpload is greater than 0 or fileToUpload is less than 100 -->
              <template
                v-else-if="
            ...
            <!-- on click trigger createBoard function -->
